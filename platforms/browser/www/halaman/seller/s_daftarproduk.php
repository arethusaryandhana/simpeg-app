  ...
  <div class="navbar" style="background-color:#088378;">
    <div class="navbar-inner ">
      ...
      <div class="right sliding"> 
        <img id="close-side-panel" src="img/menu_icon/icon refresh light.svg" width="40%" alt="" style="vertical-align:middle;margin-right: 0.5em;"/>&nbsp;
         <img id="close-side-panel" src="img/menu_icon/icon_menu_plus_light.svg"  width="40%" alt="" style="vertical-align:middle;margin-right: 0.3em"/>
